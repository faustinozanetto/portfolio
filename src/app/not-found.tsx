    ...
    <div className="bg-background-100 dark:bg-background-800 my-6 w-full rounded-lg p-4 px-4 shadow-lg sm:px-6 md:my-14 md:max-w-lg md:p-6 lg:my-20">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="max-w-lg text-center md:text-lg">
          We apologize for the inconvenience, but it seems that an error has occurred. Our team has been notified and is
          working diligently to resolve the issue.
        </p>

        <p className="max-w-lg text-center font-bold text-destructive md:text-lg">
