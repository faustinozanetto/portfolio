...
const LayoutFooter: React.FC = () => {
  return (
    <footer className="flex flex-col items-center justify-center bg-neutral-100 p-6 text-center text-neutral-900 drop-shadow-md dark:bg-neutral-900 dark:text-neutral-100 md:p-8">
